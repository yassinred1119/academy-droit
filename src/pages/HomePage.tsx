...
export default function HomePage() {
  ...
  const articles = [
    { title: "شرح الفصل 378 من القانون الجنائي المغربي", date: "24 ماي 2026", category: "القانون الجنائي" },
    { title: "التمييز بين المسؤولية العقدية والمسؤولية التقصيرية", date: "22 ماي 2026", category: "القانون المدني" },
  ];

  const news = [
    { title: "صدور قانون رقم 02.23 المتعلق بالمسطرة المدنية", date: "25 ماي 2026" },
    { title: "المجلس الأعلى يصدر قرارات جديدة حول الاجتهاد القضائي", date: "20 ماي 2026" },
  ];
  ...
  return (
    <div className="w-full min-h-screen text-right font-['Tajawal']" dir="rtl">
      ...
      {/* ==========================================================================
         📱 1. نسخة الهاتف المحمول (تظهر في شاشات الجوال وتختفي تلقائياً في الحاسوب)
         ========================================================================== */}
      ...
      <div className="hidden md:block max-w-[1400px] mx-auto px-6 py-8">
        ...
        {/* شبكة المحتوى السفلي المكونة من 3 أعمدة */}
